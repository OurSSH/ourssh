			...
			<TBODY>
							...
							<s:iterator var="u" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/AdminCustomer_findbyId.action?uid=<s:property value="#u.uid"/>&page=<s:property value="pageBean.page"/>&key=<s:property value="key"/>&value=<s:property value="value"/>">
											<img
									...
									<td align="center" style="HEIGHT: 22px"><a
										href="${ pageContext.request.contextPath }/AdminCustomer_delete.action?uid=<s:property value="#u.uid"/>&page=<s:property value="pageBean.page" />&key=<s:property value="key"/>&value=<s:property value="value"/>">
											<img
				...
				<tr align="center">
					<td colspan="7">第<s:property value="pageBean.page" />/<s:property
							...
							<a
								href="${ pageContext.request.contextPath }/AdminCustomer_KeySearch.action?page=1&key=<s:property value="key"/>&value=<s:property value="value"/>">首页</a>|
								<a
								href="${ pageContext.request.contextPath }/AdminCustomer_KeySearch.action?page=<s:property value="pageBean.page-1"/>&key=<s:property value="key"/>&value=<s:property value="value"/>">上一页</a>|
							</s:if> <s:if test="pageBean.page != pageBean.totalPage">
							<a
								href="${ pageContext.request.contextPath }/AdminCustomer_KeySearch.action?page=<s:property value="pageBean.page+1"/>&key=<s:property value="key"/>&value=<s:property value="value"/>">下一页</a>|
								<a
								href="${ pageContext.request.contextPath }/AdminCustomer_KeySearch.action?page=<s:property value="pageBean.totalPage"/>&key=<s:property value="key"/>&value=<s:property value="value"/>">尾页</a>|
							</s:if>
					</td>
				</tr>
			</TBODY>
