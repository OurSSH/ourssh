			...
			<TBODY>
						...
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<s:iterator var="o" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="5%"><s:if test="#o.state==1">
													未付款
												</s:if> <s:if test="#o.state==2">
											<a
												href="${ pageContext.request.contextPath }/AdminOrder_updateState.action?oid=<s:property value="#o.oid" />&page=<s:property value="pageBean.page" />&key=<s:property value="key"/>&value=<s:property value="value"/>"><font
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center"
										width="10%"><s:if test="#o.expressnumber!=''">
											<s:property value="#o.expressnumber" />
											<a
												href="${ pageContext.request.contextPath }/AdminOrder_addExpressnumber.action?oid=<s:property value="#o.oid"/>&page=<s:property value="pageBean.page" />&key=<s:property value="key"/>&value=<s:property value="value"/>"><font
												color="blue">修改</font></a>
										</s:if> <s:if test="#o.expressnumber==''">
											<a
												href="${ pageContext.request.contextPath }/AdminOrder_addExpressnumber.action?oid=<s:property value="#o.oid"/>&page=<s:property value="pageBean.page" />&key=<s:property value="key"/>&value=<s:property value="value"/>"><font
									...
									<s:if test="#o.state==1">
									    <a
										href="${ pageContext.request.contextPath }/AdminOrder_delete.action?oid=<s:property value="#o.oid"/>&page=<s:property value="pageBean.page" />&key=<s:property value="key"/>&value=<s:property value="value"/>">
											<img
				...
				<tr align="center">
					<td colspan="7">第<s:property value="pageBean.page" />/<s:property
							...
							<a
								href="${pageContext.request.contextPath }/AdminOrder_KeySearch.action?page=1">首页</a>|
								<a
								href="${pageContext.request.contextPath }/AdminOrder_KeySearch.action?page=<s:property value="pageBean.page-1"/>">上一页</a>|
							</s:if> <s:if test="pageBean.page != pageBean.totalPage">
							<a
								href="${pageContext.request.contextPath }/AdminOrder_KeySearch.action?page=<s:property value="pageBean.page+1"/>">下一页</a>|
								<a
								href="${pageContext.request.contextPath }/AdminOrder_KeySearch.action?page=<s:property value="pageBean.totalPage"/>">尾页</a>|
							</s:if>
					</td>
				</tr>
			</TBODY>
